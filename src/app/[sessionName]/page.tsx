      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-6 border border-gray-200">
        ...
        <section className="mb-10 p-6 bg-indigo-50 rounded-lg shadow-inner border border-indigo-200">
          ...
          <form
            ...
            className="mb-8 p-5 border border-indigo-300 rounded-md bg-white shadow-sm"
          >
                    ...
                    <div>
                      ...
                      <div className="flex space-x-3 mt-3">
                        <button
                          ...
                          className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 flex items-center space-x-2 transition-colors duration-200"
                        >
                          <FaEdit /> <span>Simpan</span>
                        </button>
                        <button
                          onClick={() => setEditingNoteId(null)}
                          className="bg-gray-400 text-white px-4 py-2 rounded-md hover:bg-gray-500 flex items-center space-x-2 transition-colors duration-200"
                        >
                          <span>Batal</span>
                        </button>
                      </div>
        ...
        <section className="p-6 bg-green-50 rounded-lg shadow-inner border border-green-200">
          ...
          <form
            ...
            className="mb-8 p-5 border border-green-300 rounded-md bg-white shadow-sm"
          >
            <h3 className="text-xl font-medium text-gray-800 mb-3">
              Unggah Berkas Baru
            </h3>
            <input
              type="file"
              className="w-full px-4 py-2 border border-gray-300 rounded-md mb-3 bg-white text-base file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100"
              onChange={(e) =>
